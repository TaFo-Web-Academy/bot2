...
саволҳо = [
    {
        ...
        'ихтиёрҳо': ['А) Худам → 3 хол', 'Б) Оила ё дигарон → 1 хол', 'В) Баъзан ман, баъзан онҳо → 2 хол',
                     'Г) Метарсам қарор гирам → 0 хол'],
        'баллҳо': [3, 1, 2, 0]
    },
    {
        'матн': '2. Вақте чизе хато мешавад, чӣ мегӯӣ?\n(Мисол: Агар кор нобарор шавад, кӣ гунаҳкор?)',
        'ихтиёрҳо': ['А) Ман айбдорам → 3 хол', 'Б) Дигарон гунаҳкоранд → 1 хол', 'В) Тақдир ҳамин будааст → 0 хол',
                     'Г) Намедонам → 2 хол'],
        'баллҳо': [3, 1, 0, 2]
    },
    {
        'матн': '3. Орзуи кӯдакиатро ёд дори?\n(Мисол: Шавам духтур, актёр, сурудхон…)',
        'ихтиёрҳо': ['А) Ҳа, ёдам ҳаст → 3 хол', 'Б) Не, фаромӯш кардам → 1 хол', 'В) Ман дигар орзу надорам → 0 хол'],
        'баллҳо': [3, 1, 0]
    },
    {
        'матн': '4. (🧠)(Подсознание)"Зершуур" чӣ маъно дорад?\n(Мисол: Фикрҳои пинҳон, ҳиссиёте ки медонӣ, вале намебинӣ)',
        'ихтиёрҳо': ['А) Қувваи дохилӣ → 3 хол', 'Б) Барои равоншиносон → 1 хол',
                     'В) Ман намефаҳмам, ле ҷолиб аст → 2 хол', 'Г) Ман бовар надорам → 0 хол'],
        'баллҳо': [3, 1, 2, 0]
    },
    {
        'матн': '5. Оё касе зиндагии туро идора мекунад?\n(Мисол: Ман худам зиндагимро метарошам ё фикрҳои кӯҳна маро идора мекунанд?)',
        'ихтиёрҳо': ['А) Ҳа, пай бурдаам → 3 хол', 'Б) Шояд, меҷӯям → 2 хол', 'В) Не, ҳамаашро ман медонам → 1 хол',
                     'Г) Намефаҳмам → 0 хол'],
        'баллҳо': [3, 2, 1, 0]
    },
    {
        'матн': '6. Ту ҳис мекунӣ, ки зиндагиат аз они туст?\n(Мисол: Ин зиндагиро худам сохтаам ё маҷбурона зиндагӣ мекунам?)',
        'ихтиёрҳо': ['А) Ҳа, ман соҳиби зиндагиям → 3 хол', 'Б) Баъзан чунин ҳис мекунам → 1 хол',
                     'В) Не, фикр мекунам барои дигарон зиндагӣ мекунам → 0 хол', 'Г) Ман намедонам → 2 хол'],
        'баллҳо': [3, 1, 0, 2]
    },
    {
        'матн': '7. Овози дили ту чӣ мегӯяд?\n(Мисол: Даруни ту чӣ мегӯяд — рав, бозист, тарс?)',
        'ихтиёрҳо': ['А) Метавонӣ! → 3 хол', 'Б) Эҳтимол набарояд… → 1 хол', 'В) То ҳол сабр кун → 2 хол',
                     'Г) Хомӯш аст → 0 хол'],
        'баллҳо': [3, 1, 2, 0]
    },
    {
        'матн': '8. (🧠)(Подсознание)Зершуур чӣ кор карда метавонад?\n(Мисол: Ба ман кӯмак мекунад ё не?)',
        'ихтиёрҳо': ['А) Маро озод мекунад → 3 хол', 'Б) Ёрӣ медиҳад, ки бахшам → 2 хол', 'В) Ман намефаҳмам → 1 хол',
                     'Г) Ман ба ин чизҳо бовар надорам → 0 хол'],
        'баллҳо': [3, 2, 1, 0]
    },
    {
        'матн': '9. Агар як варақи хол дошта бошӣ, чӣ менависӣ?\n(Мисол: Шояд "Ман мехоҳам хона созам", ё "Намедонам чӣ бихоҳам")',
        'ихтиёрҳо': ['А) Орзую муҳаббат → 3 хол', 'Б) Намедонам → 1 хол', 'В) "Ҳарчи шавад шавад" → 0 хол'],
        'баллҳо': [3, 1, 0]
    },
    {
        'матн': '10. Омодаӣ зиндагиро худад нависӣ?\n(Мисол: Ба ҷои шикоят, зиндагиро дигар кардан мехоҳӣ?)',
        'ихтиёрҳо': ['А) Ҳа, албатта → 3 хол', 'Б) Мехоҳам, вале метарсам → 2 хол', 'В) Ҳоло намефаҳмам → 1 хол',
                     'Г) Не, ҳамин ҳаётро қабул кардам → 0 хол'],
        'баллҳо': [3, 2, 1, 0]
    }
]
